    ...
    <body >
		...
		<div class="container" style="margin-top:100px; ">
			...
			<?php
				...
				// $sqlcommand="select * from document where deleted = 0 and status = 1 and category_id = $id";
				...
				$sql = "select * from document where deleted = 0 and status =1 ";
				...
				if(isset($_GET['category_id']))
				{
					...
					$sql = "select *
							from document 
							where category_id = $id and deleted = 0 and status=1 ";
				}
...
<!--<div class="row">
				<div style="margin:0 250;">
					// <?php
						...
						// {
							// echo "<button style='margin:5px'><a style='color:black;'  href ='theloai.php?page=$i'>Trang $i</a></button>";
