...
<?php 
	...
	if(isset($_POST['btnthem']))
	{
			...
			$sql = "insert into document(filename, category_id, title, thumbnail,user_id,downloads,status,deleted,created_at)
					values('".$filename."','".$category_id."','".$title."','".$thumbnail."','".$user_id."','0','0','0','".$created_at."')";
